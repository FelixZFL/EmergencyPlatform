...
#pragma mark - AndyAdd
- (void)setFooterNoMoreText:(NSString *)footerNoMoreText
{
    self.header.footerNoMoreText = footerNoMoreText;
}

- (NSString *)footerNoMoreText
{
    return self.header.footerNoMoreText;
}
