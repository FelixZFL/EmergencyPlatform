                                     ...
                                     usingBlock:^(ALAssetsGroup *assetsGroup, BOOL *stop)
         {
             ...
             if ([assetsGroupID isEqualToString:propwetyID]) {
                 *stop = YES;
                 ...
                 albumTableViewController.picCount = self.picCount;
                 albumTableViewController.selectMaxCount = self.selectMaxCount;
                 
                 DNImageFlowViewController *imageFlowController = [[DNImageFlowViewController alloc] initWithGroupURL:assetsGroupURL];
                 imageFlowController.picCount = self.picCount;
                 imageFlowController.selectMaxCount = self.selectMaxCount;
