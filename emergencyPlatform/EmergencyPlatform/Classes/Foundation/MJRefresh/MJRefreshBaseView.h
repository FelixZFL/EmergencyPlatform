...
//刷新时间倒计时 默认时间 add by modeguang
#define DefalutHadEndSecond 8
...
//刷新时间倒计时 add by modeguang
@property (assign,nonatomic) int hadEndSeconds;
#pragma mark - 回调
/**
 *  开始进入刷新状态的监听器
 */
...
@property (copy, nonatomic) NSString *footerNoMoreText;
